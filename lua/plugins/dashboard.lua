...
db.setup{
	...
	config = {
		...
		center = {
			{icon = '  ', desc = "Find File                 <leader> s f", action = "Telescope find_files"},
	    	{icon = '  ', desc = "Recents                   <leader>   ?", action = "Telescope oldfiles"},
	    	{icon = '󰮗  ', desc = "Find Word                 <leader> s p", action = "Telescope live_grep"},
		},
		footer = {
			randomText,
			"	",
